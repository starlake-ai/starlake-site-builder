...
export function Sidebar({
  ...
  return (
    <aside
      className={cn(
        "flex h-full w-72 min-w-[18rem] flex-col border-r border-sidebar-border/50 bg-sidebar/50 backdrop-blur-sm text-sidebar-foreground transition-all duration-300",
        "hidden md:flex",
        className
      )}
    >
